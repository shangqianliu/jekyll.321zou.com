...
### 前言
上一篇介绍了[如果用github写博客](https://blog.max.top-min.top/2018/10/01/writeblogwithgithub.html?_blank)，github后台会生成静态文件内容，而这个生成静态文件的功能就是由jekyll完成，而且jekyll可以本地安装，下面就讲解如果搭建本地环境。
